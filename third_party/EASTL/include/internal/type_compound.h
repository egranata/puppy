...
namespace std
{
	...
	struct is_member_pointer 
		: public std::integral_constant<bool, std::is_member_function_pointer<T>::value>{};
	...
	#define EASTL_DECLARE_ENUM(T) namespace std{ template <> struct is_enum<T> : public true_type{}; template <> struct is_enum<const T> : public true_type{}; }
