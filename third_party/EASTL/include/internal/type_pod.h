...
namespace std
{
	...
	///////////////////////////////////////////////////////////////////////
		...
		struct is_assignable_helper
		{
			...
			static const bool eitherIsArray = (std::is_array<T1>::value || std::is_array<U1>::value);
			static const bool isArithmetic  = (std::is_arithmetic<T1>::value && std::is_arithmetic<U1>::value);
			static const bool isSameScalar  = (std::is_same<T1, U1>::value && std::is_scalar<T1>::value && std::is_scalar<U1>::value);
			static const bool isTConst      = std::is_const<T1>::value;
	...
	///////////////////////////////////////////////////////////////////////
		...
		template <typename T, typename U = decltype(std::declval<std::destructible_test_helper<T> >().~destructible_test_helper<T>())>
